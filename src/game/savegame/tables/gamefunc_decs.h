...
extern void badass_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void cyborg_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void kigrax_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void proximity_mine_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void spider_die (edict_t *, edict_t *, edict_t *, int, const vec3_t);
...
extern void badass_pain (edict_t *, edict_t *, float, int);
...
extern void cyborg_pain (edict_t *, edict_t *, float, int);
...
extern void iredbomb_pain (edict_t *, edict_t *, float, int);
extern void jorg_pain (edict_t *, edict_t *, float, int);
extern void kigrax_pain (edict_t *, edict_t *, float, int);
...
extern void spider_pain (edict_t *, edict_t *, float, int);
...
extern void badass_die_gibs (edict_t *);
extern void badass_gib_explosion (edict_t *);
extern void badass_gib_think (edict_t *);
...
extern void hellfury_think (edict_t *);
extern void hover_deadthink (edict_t *);
extern void hunter_think (edict_t *);
extern void ionripper_sparks (edict_t *);
extern void ired_explode (edict_t *);
extern void ired_laser_on (edict_t *);
extern void ired_laser_think (edict_t *);
extern void iredbomb_off (edict_t *);
extern void iredbomb_think (edict_t *);
...
extern void misc_screenfader_begin (edict_t *);
extern void misc_screenfader_clearhold (edict_t *);
extern void misc_screenfader_update (edict_t *);
...
extern void pistol_bolt_think (edict_t *);
...
extern void proximity_mine_explode (edict_t *);
extern void proximity_mine_laser_start (edict_t *);
extern void proximity_mine_laser_think (edict_t *);
extern void proximity_mine_think (edict_t *);
extern void rotate_train_find (edict_t *);
extern void rotate_train_next (edict_t *);
...
extern void cyborg_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void deatom_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
...
extern void ired_shrapnel_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
...
extern void pistol_bolt_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
extern void plasma_bolt_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
...
extern void proximity_mine_touch (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
...
extern void spider_charge_think (edict_t *, edict_t *, const cplane_t *, const csurface_t *);
...
extern void misc_screenfader_use (edict_t *, edict_t *, edict_t *);
...
extern void rotate_train_use (edict_t *, edict_t *, edict_t *);
...
extern void use_target_railgun (edict_t *, edict_t *, edict_t *);
extern void use_target_rocket (edict_t *, edict_t *, edict_t *);
...
extern void badass_stand (edict_t *);
...
extern void cyborg_stand (edict_t *);
...
extern void kigrax_stand (edict_t *);
...
extern void badass_walk (edict_t *);
...
extern void cyborg_walk (edict_t *);
...
extern void kigrax_walk (edict_t *);
...
extern void spider_walk (edict_t *);
...
extern void army_run (edict_t *);
extern void badass_run (edict_t *);
...
extern void cyborg_run (edict_t *);
extern void demon_run (edict_t *);
extern void dog_run (edict_t *);
...
extern void kigrax_run (edict_t *);
extern void knight_run (edict_t *);
...
extern void spider_run (edict_t *);
...
extern void kigrax_melee (edict_t *);
...
extern void spider_melee (edict_t *);
...
extern void cyborg_attack (edict_t *);
...
extern void kigrax_attack (edict_t *);
...
extern void spider_attack (edict_t *);
...
extern qboolean cyborg_checkattack (edict_t *);
...
extern qboolean spider_checkattack (edict_t *);
...
// monsterinfo.idle
extern void badass_idle (edict_t *);
extern void brain_idle (edict_t *);
extern void cyborg_idle (edict_t *);
...
extern void spider_idle (edict_t *);
...
extern void cyborg_search (edict_t *);
...
extern void kigrax_search (edict_t *);
...
extern void spider_search (edict_t *);
...
extern void badass_sight (edict_t *, edict_t *);
...
extern void cyborg_sight (edict_t *, edict_t *);
...
extern void kigrax_sight (edict_t *, edict_t *);
...
extern void spider_sight (edict_t *, edict_t *);
