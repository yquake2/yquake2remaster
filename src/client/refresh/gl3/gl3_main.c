...
static void
GL3_DrawParticles_Worker(size_t start, size_t end, void *user)
{
	const gl3_particle_job_t *job = (const gl3_particle_job_t *)user;
	size_t i;
...
R_GetSpeedString(void)
{
	...
	num3D = gl3_num3Ddraws;
	num2D = gl3_num2Ddraws;
	numBufVtx = gl3_numBufferVtxData;
	numBufUni = gl3_numBufferUniforms;
	gl3_num3Ddraws = 0;
	gl3_num2Ddraws = 0;
