# Asset Support Specifications

This document details the supported file formats for models, textures, sprites, maps, sounds, and package files in Yamagi Quake II Remaster.
...
Note:
* Non Quake 2 maps are limited mostly view only, and could have issues with transparency or some animations flags and properties.
